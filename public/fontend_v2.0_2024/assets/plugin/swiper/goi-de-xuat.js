if ($(".swiper.goi-de-xuat").length) {
    function sw_goi_de_xuat() {
        var swiper = new Swiper('.swiper.goi-de-xuat', {
            ...
            // simulateTouch: true, // giữ thao tác kéo bằng chuột
        });
    }
...
if ($(".swiper.sw-goi-de-xuat-5").length) {
    function sw_goi_de_xuat_5() {
        console.log('sw_goi_de_xuat_5');
        var swiper = new Swiper('.swiper.sw-goi-de-xuat-5', {
            slidesPerView: 4,
            spaceBetween: 24,
            navigation: {
                nextEl: '.parents_goi-de-xuat-5 .swiper-button-next',
                prevEl: '.parents_goi-de-xuat-5 .swiper-button-prev',
            },
            breakpoints: {
                1500: {// 1280
                    slidesPerView: 4,
    ...
    $(document).ready(function () {
        ...
        if ($(".parents_goi-de-xuat-5 .swiper-button-disabled.swiper-button-lock").length > 0) { // check if swiper button is locked
            $(".swiper.sw-goi-de-xuat-5 .swiper-wrapper").addClass('js_wrapper_goi_de_xuat');
        }

        if ($(".swiper.sw-goi-de-xuat-5 .swiper-slide.with-de-xuat").length == 0) { // nếu có gói đề xuất thì set lại padding của tiêu đề
            $(".swiper.sw-goi-de-xuat-5 .swiper-slide .package-content").addClass('not_label_goi_de_xuat');
            $(".row-goi-de-xuat-homepage .new-title-label").removeClass('padding_new_title_label');
            //
        } 
        if ($(".swiper.sw-goi-de-xuat-5 .swiper-slide.with-de-xuat").length > 0) {
            // console.log('co gói đề xuất');
            $(".row-goi-de-xuat-homepage .new-title-label").addClass('padding_new_title_label');
        }
    });
...
if ($(".swiper.sw-goi-de-xuat-6").length) {
    function sw_goi_de_xuat_6() {
        var swiper = new Swiper('.swiper.sw-goi-de-xuat-6', {
            slidesPerView: 4,
            spaceBetween: 24,
            navigation: {
                nextEl: '.parents_goi-de-xuat-6 .swiper-button-next',
                prevEl: '.parents_goi-de-xuat-6 .swiper-button-prev',
            },
            breakpoints: {
                1500: {// 1280
                    slidesPerView: 4,
    ...
    $(document).ready(function () {
        ...
        if ($(".parents_goi-de-xuat-6 .swiper-button-disabled.swiper-button-lock").length > 0) { // check if swiper button is locked
            $(".swiper.sw-goi-de-xuat-6 .swiper-wrapper").addClass('js_wrapper_goi_de_xuat');
        }

        if ($(".swiper.sw-goi-de-xuat-6 .swiper-slide.with-de-xuat").length == 0) { // nếu có gói đề xuất thì set lại padding của tiêu đề
            $(".swiper.sw-goi-de-xuat-6 .swiper-slide .package-content").addClass('not_label_goi_de_xuat');
            $(".row-goi-de-xuat-homepage .new-title-label").removeClass('padding_new_title_label');
            //
        } 
        if ($(".swiper.sw-goi-de-xuat-6 .swiper-slide.with-de-xuat").length > 0) {
            // console.log('có gói đề xuất');
            $(".row-goi-de-xuat-homepage .new-title-label").addClass('padding_new_title_label');
        }
    });
}

if ($(".swiper.sw-goi-de-xuat-7").length) {
    function sw_goi_de_xuat_7() {
        var swiper = new Swiper('.swiper.sw-goi-de-xuat-7', {
            slidesPerView: 4,
            spaceBetween: 24,
            navigation: {
                nextEl: '.parents_goi-de-xuat-7 .swiper-button-next',
                prevEl: '.parents_goi-de-xuat-7 .swiper-button-prev',
            },
            breakpoints: {
                1500: {// 1280
                    slidesPerView: 4,
    ...
    $(document).ready(function () {
        ...
        if ($(".parents_goi-de-xuat-7 .swiper-button-disabled.swiper-button-lock").length > 0) { // check if swiper button is locked
            $(".swiper.sw-goi-de-xuat-7 .swiper-wrapper").addClass('js_wrapper_goi_de_xuat');
        }

        if ($(".swiper.sw-goi-de-xuat-7 .swiper-slide.with-de-xuat").length == 0) { // nếu có gói đề xuất thì set lại padding của tiêu đề
            $(".swiper.sw-goi-de-xuat-7 .swiper-slide .package-content").addClass('not_label_goi_de_xuat');
            $(".row-goi-de-xuat-homepage .new-title-label").removeClass('padding_new_title_label');
            //
        } 
        if ($(".swiper.sw-goi-de-xuat-7 .swiper-slide.with-de-xuat").length > 0) {
            // console.log('có gói đề xuất');
            $(".row-goi-de-xuat-homepage .new-title-label").addClass('padding_new_title_label');
        }
    });
...
if ($(".swiper.sw-goi-de-xuat-8").length) {
    function sw_goi_de_xuat_8() {
        var swiper = new Swiper('.swiper.sw-goi-de-xuat-8', {
            slidesPerView: 4,
            spaceBetween: 24,
            navigation: {
                nextEl: '.parents_goi-de-xuat-8 .swiper-button-next',
                prevEl: '.parents_goi-de-xuat-8 .swiper-button-prev',
            },
            breakpoints: {
                1500: {// 1280
                    slidesPerView: 4,
    ...
    $(document).ready(function () {
        ...
        if ($(".parents_goi-de-xuat-8 .swiper-button-disabled.swiper-button-lock").length > 0) { // check if swiper button is locked
            $(".swiper.sw-goi-de-xuat-8 .swiper-wrapper").addClass('js_wrapper_goi_de_xuat');
        }

        if ($(".swiper.sw-goi-de-xuat-8 .swiper-slide.with-de-xuat").length == 0) { // nếu có gói đề xuất thì set lại padding của tiêu đề
            $(".swiper.sw-goi-de-xuat-8 .swiper-slide .package-content").addClass('not_label_goi_de_xuat');
            $(".row-goi-de-xuat-homepage .new-title-label").removeClass('padding_new_title_label');
            //
        } 
        if ($(".swiper.sw-goi-de-xuat-8 .swiper-slide.with-de-xuat").length > 0) {
            // console.log('có gói đề xuất');
            $(".row-goi-de-xuat-homepage .new-title-label").addClass('padding_new_title_label');
        }
    });
