...
(function ($) {
    ...
    $.fn.snow = function () {
        ...
        if (!userCanvas) {
            ...
            $(this).each(function (i, e) {
                setting["image"] = $(e).attr("image") || "https://fpt.vn/storage/upload/images/services/logos/snow.png";
                $(this).remove();
                createSnow("", 40);
            });
        }
    ...
    i.prototype = {
        createEl: function (a, b) {
            ...
            this.el.setAttribute("src", b || "https://fpt.vn/storage/upload/images/services/logos/snow.png");
