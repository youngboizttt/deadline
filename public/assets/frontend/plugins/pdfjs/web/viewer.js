 ...
 (function () {
  ...
  (function (root, factory) {
   ...
   function configure(PDFJS) {
    PDFJS.imageResourcesPath = BASE_URL + '/web/images';    // './images/';
    PDFJS.workerSrc = BASE_URL + '/build/pdf.worker.js';  // '../build/pdf.worker.js';
    PDFJS.cMapUrl = BASE_URL + '/web/cmaps/';      // '../web/cmaps/';
...
function getViewerConfiguration() {
 return {
  ...
  debuggerScriptPath: BASE_URL + '/web/debugger.js'
 };
}
