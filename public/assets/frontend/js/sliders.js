...
var sliderOtherNews;
var oldWidth = 0;
var curIndex = function(currentIndex) {
    $(".fix-bxslider").css("visibility", "visible");
    $(".fix-bxslider").css("height", "auto");
  };
...
$(document).ready(function () {
    ...
    if (window.innerWidth >= 768) {
        ...
        if ($('.bxslider-large')) {
            sliderLarge = $('.bxslider-large').bxSlider({
